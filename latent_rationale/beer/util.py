...
def get_args():
    ...
    parser.add_argument('--embeddings', type=str,
                        default="/data/lnyue/mi_nlp/beer/review+wiki.filtered.200.txt.gz",
                        help="path to external embeddings")
    parser.add_argument('--train_path', type=str,
                        default="/home/lnyue/mi_exp/interpretable_predictions-master/data/beer/reviews.aspect0.train.txt.gz")
    parser.add_argument('--dev_path', type=str,
                        default="/home/lnyue/mi_exp/interpretable_predictions-master/data/beer/reviews.aspect0.heldout.txt.gz")
    parser.add_argument('--test_path', type=str,
                        default="/home/lnyue/mi_exp/interpretable_predictions-master/data/beer/annotations.json")
    ...
    parser.add_argument('--upper_bound', type=float, default=0.01)
    ...
    parser.add_argument('--model', choices=["baseline", "latent", "rl","ib",'rl_gumbal'],
                        default="baseline")

...
class LatentRationaleModel(nn.Module):
    ...
    def forward(self, x):
        ...
        self.x_samples = self.classifier(x, mask, z)
        self.y_samples = self.classifier(x, mask, (1-z))
    ...
    def get_loss(self, preds, targets, mask=None):
        ...
        c0_hat = torch.abs(l0 - self.selection)
        ...
        loss = 10*mse + self.lambda0.detach() * c0
        ...
        # lagrange dissatisfaction, batch average of the constraint
        #c1_hat =torch.abs(lasso_cost - target1)
...
class LatentRationaleModel2(nn.Module):
    """
    Latent Rationale
    ...
    def __init__(self,
        ...
        super(LatentRationaleModel2, self).__init__()
    ...
    def forward(self, x):
        ...
        #     y = self.output_layer(self.x_samples)
        # else:
        #     y = self.output_layer(self.y_samples)
        return y
